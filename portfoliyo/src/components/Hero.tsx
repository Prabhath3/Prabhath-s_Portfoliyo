...
function Hero({ name }: UserName) {
    ...
    return (
        <section className="min-h-screen bg-zinc-950 text-white flex items-center px-8 md:px-16">
            <div className="max-w-3xl">
                <p className="text-purple-400 text-lg mb-4">AI & Robotics Enthusiast</p>
